...
7. Choose one exhibition to remix.​
8. Choose a name for your narrative.

### Editing the Objects
1. Wait for the Exhibition to load and for the Objects to appear.
2. Point your hand at an Object; a white line from the controller to the Object shows what it is selected.​
3. Use the pinch gesture to grab and move the Objects to the desired orientations and positions​.
4. At any point, you can **Save**.
5. When finished, use the menu option **Save and Exit** to store your changes and exit.​
### Watching the narrative
1. Go back to the main menu and select See Local Exhibit to open the just created narrative.
2. Enjoy!
